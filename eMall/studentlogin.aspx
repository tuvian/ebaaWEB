<%@ Page Title="" Language="C#" MasterPageFile="~/mySkool.Master" AutoEventWireup="true" CodeBehind="studentlogin.aspx.cs" Inherits="eMall.studentlogin" %>
            ...
            <tr>
                <td>
                    <asp:GridView runat="server" ID="GridItems" AutoGenerateColumns="False" PageSize="10"
                        ...
                        DataKeyNames="login_id,school_id,student_id,name,mobile,email,username,password,type,student_code,device_id">
                    ...
                    <asp:UpdatePanel ID="upschoollogin" runat="server">
                        <ContentTemplate>
                            <table width="100%">
                                ...
                                <tr>
                                    <td align="left" class="adminLabel">
                                        <asp:Label runat="server" ID="Label3" Text="Student Code"></asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:DropDownList ID="ddlStudentCode" runat="server" CssClass="adminCombo" AutoPostBack="true" OnSelectedIndexChanged="ddlStudentCode_SelectedIndexChanged">
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlStudentCode"
                                            ErrorMessage="*" ValidationGroup="items" ToolTip="Please select a Teacher Code" InitialValue="0" />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" class="adminLabel">
                                        <asp:Label runat="server" ID="Label2" Text="Student's Name"></asp:Label>
                                    </td>
                                    <td align="left">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox runat="server" ID="txtUserName" ValidationGroup="items" MaxLength="20"
                                            CssClass="adminText" ReadOnly="true" />
                                ...
                                <tr>
                                    <td align="left" class="adminLabel">
                                        <asp:Label runat="server" ID="Label4" Text="Device ID"></asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:TextBox runat="server" ID="txtDeviceID" ValidationGroup="items" MaxLength="20"
                                            CssClass="adminText" />
                                    </td>
                                </tr>
                            </table>
