<%@ Page Title="" Language="C#" MasterPageFile="~/mySkool.Master" AutoEventWireup="true" CodeBehind="users.aspx.cs" Inherits="eMall.users" %>
            ...
            <tr>
                <td>
                    <asp:GridView runat="server" ID="GridItems" AutoGenerateColumns="False" PageSize="10"
                        ...
                        DataKeyNames="id,school_id,code,name,mobile,email,username,password,type">
                        ...
                        <ContentTemplate>
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox runat="server" ID="txtName" ValidationGroup="items" MaxLength="40" CssClass="adminText" ReadOnly="true" />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" class="adminLabel">
